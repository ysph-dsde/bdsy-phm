...
# the population!) were infected at one time (looks like around 2 months in), 
# and by day 100, almost everyone has recovered from infection. Try messing 
# around with the parameters, time of the simulation, and population starting 
# size to see how it changes your plot.
...
# So now at the end of our 100 days, around 100 people have died. Since we didn't 
# change the other parameters, the peak number of infections has stayed the same, 
# and at the same time point. Go ahead and mess with the parameters above to see 
...
# Now I hope you're getting the idea about how adding compartments and parameters 
# works. 
