...
**Code:**
{{< downloadthis "R/MinimalDE.R" label="Hierarchical Modeling Code" id=download_btn >}} {{< downloadthis "R/Model2.R" label="Model Statements" id=download_btn >}}

**Date:**
{{< downloadthis "Data/testDE2.csv" label="Data" id=download_btn >}}
