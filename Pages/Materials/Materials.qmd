...
{{< downloadthis "Student Codespaces/Week 5 Code.R" label="Week 5 code" id=download_btn >}}
...
{{< downloadthis "Student Project Materials/malawi_genomic_output.zip" label="Malawi Genomics Output" id=download_btn >}} Find the preprocessed genomics results using a subset of the full data that have been run through the GPS analysis pipeline.
...
{{< downloadthis "Student Project Materials/nepal_genomic_output.zip" label="Nepal Genomics Output" id=download_btn >}} Find the preprocessed genomics results using a subset of the full data that have been run through the GPS analysis pipeline.
...
{{< downloadthis "Student Project Materials/peru_genomic_output.zip" label="Peru Genomics Output" id=download_btn >}} Find the preprocessed genomics results using a subset of the full data that have been run through the GPS analysis pipeline.
